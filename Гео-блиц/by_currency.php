...
<head>
    ...
    <title>Угадай страну по валюте</title>
    <link rel="stylesheet" href="styles.css">
</head>
<body style="background-image: url('backgrounds/background_curr.png');">
    <div class="header">
    ...
    <div class="question-container">
        ...
        <div style="text-align: center; margin-bottom: 20px;">
            <img id="currency-image" src="" alt="Валюта" style="max-width: 100%; max-height: 200px; border-radius: 5px;">
        </div>
    ...
    <script>
        ...
        const gamemode = "по валюте";

        // Функция для загрузки списка валют и стран
        async function loadCurrencies() {
            try {
                const response = await fetch('lists/currencies_list.txt');
                ...
                alert('Ошибка загрузки файла с валютами: ' + error.message);
            }
        }
        ...
        function generateQuestion() {
            ...
            currencyImage.src = `currencies/${currentQuestion.currency}`;
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'saveScore') {
        ...
        $gamemode = isset($_POST['gamemode']) ? $_POST['gamemode'] : 'по валюте';
