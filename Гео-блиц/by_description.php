...
<head>
    ...
    <title>Угадай страну по описанию</title>
    <link rel="stylesheet" href="styles.css">
</head>
<body style="background-image: url('backgrounds/background_desc.png');">
    <div class="header">
    ...
    <div class="question-container">
        ...
        <div class="description" id="description-text">Загрузка...</div>
    ...
    <script>
        ...
        const gamemode = "по описанию";

        // Функция для загрузки вопросов из файла
        async function loadQuestions() {
            try {
                const response = await fetch('lists/questions_desc.txt');
                ...
                alert('Ошибка загрузки файла с вопросами: ' + error.message);
            }
        }
        ...
        function generateQuestion() {
            ...
            document.getElementById('description-text').textContent = currentQuestion.description;
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'saveScore') {
        ...
        $gamemode = isset($_POST['gamemode']) ? $_POST['gamemode'] : 'по описанию';
